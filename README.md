...
| Section | Description |
|---|---|
| **Hero** | Introduction, name, role, and CTA buttons |
| **Skills** | Tech stack with animated progress bars |
| **Experience** | Internship at CODETECH IT Solutions |
| **Projects** | 4 featured full stack projects |
...
1. Clone the repo:
   ```bash
   git clone https://github.com/Akshta31/My-Portfolio.git
   ```
